...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-480ac1de", Component.options)
  } else {
    hotAPI.reload("data-v-480ac1de", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
// module
exports.push([module.i, "\nul li{\n    margin: 0;\n    padding: 0;\n}\nul {\n    list-style: none;\n}\n", "", {"version":3,"sources":["/./app.vue?79c04b0c"],"names":[],"mappings":";AAyBA;IACA,UAAA;IACA,WAAA;CACA;AACA;IACA,iBAAA;CACA","file":"app.vue","sourcesContent":["<template>\n    <vue-antiscroll :height=\"300\">\n        <ul>\n            <li v-for=\"item in arr\">\n                {{item.name}}\n            </li>\n        </ul>\n    </vue-antiscroll>\n</template>\n<script>\n    export default {\n    \tdata () {\n    \t\tlet arr = Array.apply(null, {length : 100}).map((el, index) => {\n    \t\t\treturn {\n    \t\t\t\tid: index,\n                    name: `xxxfsfsdfffff@第${index}个`\n                }\n            })\n    \t\treturn {\n    \t\t\tarr\n            }\n        }\n    }\n</script>\n<style>\n    ul li{\n        margin: 0;\n        padding: 0;\n    }\n    ul {\n        list-style: none;\n    }\n</style>"],"sourceRoot":"webpack://"}]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('vue-antiscroll', {
    attrs: {
      "height": 300
    }
  }, [_c('ul', _vm._l((_vm.arr), function(item) {
    return _c('li', [_vm._v("\n            " + _vm._s(item.name) + "\n        ")])
  }))])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-480ac1de", module.exports)
  }
}
...
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!./node_modules/css-loader/index.js?sourceMap!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-480ac1de\",\"scoped\":false,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./app.vue", function() {
     var newContent = require("!!./node_modules/css-loader/index.js?sourceMap!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-480ac1de\",\"scoped\":false,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./app.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
